        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArchivedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ArchivedManually = table.Column<bool>(type: "boolean", nullable: false),
                    PreviousColumnId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoardMembers_UserId_Order",
                table: "BoardMembers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cards_ColumnId_Order_Active",
                table: "Cards",
                columns: new[] { "ColumnId", "Order" },
                unique: true,
                filter: "\"ArchivedAt\" IS NULL AND \"ColumnId\" IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Columns_BoardId_Order_Active",
                table: "Columns",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_IsDemo_CreatedAt",
                table: "Users",
                columns: new[] { "IsDemo", "CreatedAt" });
